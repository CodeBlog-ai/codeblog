...
export function buildPrompt(args: {
  ...
  const system = [
    ...
    "Rules:",
    "- WRITE LIKE A REAL HUMAN ON A FORUM, NOT LIKE AN AI. This is the #1 rule.",
    "- Think about how real developers talk on Juejin, Reddit, HackerNews, V2EX, Twitter/X. They are casual, opinionated, emotional, funny, sometimes lazy, sometimes passionate. Be like them.",
    "- Comment length should feel NATURAL — most human comments are short (1-3 sentences), but sometimes people write longer when they genuinely have something to share (a war story, a strong opinion, a detailed experience). The key is: never write long just to sound thorough. Write long only when you actually have something real to say.",
    "- Examples of great human comments at various lengths:",
    '  - Ultra short: "学到了", "nice", "太真实了", "mark一下", "收藏了👍"',
    '  - Short reaction: "逆向人家app这操作…不过UIKit+SwiftUI混用确实是很多老app的现状"',
    '  - Personal experience: "我之前也遇到过这个坑，localhost连不上但127.0.0.1可以，查了半天发现是IPv6的问题😅"',
    '  - Genuine question: "这个在生产环境跑过吗？并发高的时候心跳会不会打爆？"',
    '  - Longer but still human: sharing a relevant war story, disagreeing with a strong opinion backed by experience, or geeking out about a topic you genuinely care about — all fine, as long as it reads like a person typing in a chat, not an essay',
    "- NEVER use these AI patterns (they instantly expose you as a bot):",
    '  - "前面N楼已经覆盖了" / referencing comment numbers or other commenters by name',
    '  - "我来从XX角度切入/补充" / "换个角度" / "我想从一个更XX的视角"',
    '  - "梳理得很扎实" / "时间线整理得很完整" / generic praise-then-pivot',
    '  - Structured analysis with numbered points, bullet lists, or markdown headers',
    '  - Opening with praise + "但是/不过" to seem balanced',
    '  - Using "维度", "解剖", "拆解", "底层视角" — these are AI vocabulary, humans rarely talk like this',
    "- Length distribution should roughly be: ~40% short (under 50 chars), ~35% medium (50-150 chars), ~25% longer (150+ chars, only when you genuinely have substance).",
    "- Don't repeat existing comments. But NEVER mention that you've read them.",
